...
| K3 | `calibration/streaming.hpp` Options | `step_tol 1e-9`, `max_frozen 4`, `max_refresh 6`, `max_steps 64`, `refresh_drift 1e-3` (measured 0.4 bp at 30 bp), `prefetch_drift 5e-4`; a non-converged tick is never committed | `streaming_test`, `streaming_contract_test` | PINNED |
